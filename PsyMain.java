public class PsyMain{
    public static void main(String[] args) {
        // INTACT PARTICIPANTS DATA. Read from left to right just as from top to bottom in the sheet.
        ...
        // SPLIT BRAIN PARTICIPANTS DATA. Read from left to right just as from top to bottom in the sheet.
